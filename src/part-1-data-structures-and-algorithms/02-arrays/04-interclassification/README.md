...
export function displayUnionAndIntersection(setA: number[], setB: number[]): { union: number[]; intersection: number[] } {
  // Your code here
}
...
export function displayUniqueMultiples(x: number, a: number[], b: number[]): number[] {
  // Your code here
}
...
export function displayCommonElementsFromThree(a: number[], b: number[], c: number[]): number[] {
  // Your code here
}
